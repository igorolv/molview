...
const GeometryInfo& geometryFor(int sigma, int lonePairs) {
    ...
    static const std::map<std::string, GeometryInfo> table = {
        {"1:0", {"одна связь", "концевой атом", 0, false, "У атома единственный сосед — валентного угла нет."}},
        {"1:1", {"линейная", "концевой атом", 0, false, "Одна связь и одна неподелённая пара (азот в HC≡N)."}},
        {"1:2", {"тригональная", "концевой атом", 0, false, "Одна связь и две пары — например, кислород карбонильной группы C=O."}},
        {"1:3", {"тетраэдрическая", "концевой атом", 0, false, "Одна связь и три пары — галогены, гидроксид-ион."}},

        {"2:0", {"линейная", "линейная", 180, true, "Две электронные группы расходятся на 180°: CO₂, BeCl₂, ацетилен."}},
        {"2:1", {"тригональная", "угловая", 120, true, "Две связи и одна пара — угловая молекула: SO₂, озон, нитрит-ион."}},
        {"2:2", {"тетраэдрическая", "угловая", 109.5, true, "Две связи и две пары: вода, сероводород, спирты и эфиры."}},
        {"2:3", {"тригонально-бипирамидальная", "линейная", 180, true, "Три пары уходят в экватор, связи остаются на оси: XeF₂."}},

        {"3:0", {"тригональная", "плоская треугольная", 120, true, "Плоский треугольник: BF₃, SO₃, нитрат-ион, любой sp²-углерод."}},
        {"3:1", {"тетраэдрическая", "тригонально-пирамидальная", 109.5, true, "Пирамида: аммиак, PCl₃, ион гидроксония, сера в ДМСО."}},
        {"3:2", {"тригонально-бипирамидальная", "Т-образная", 90, true, "Обе пары в экваторе, связи образуют букву «Т»: ClF₃."}},

        {"4:0", {"тетраэдрическая", "тетраэдрическая", 109.5, true, "Правильный тетраэдр: метан, ион аммония, сульфат-ион."}},
        {"4:1", {"тригонально-бипирамидальная", "качели (дисфеноид)", 120, true, "Пара занимает экваториальную позицию: SF₄."}},
        {"4:2", {"октаэдрическая", "квадратная", 90, true, "Пары становятся транс, связи образуют плоский квадрат: XeF₄."}},

        {"5:0", {"тригонально-бипирамидальная", "тригонально-бипирамидальная", 120, true, "Две неравноценные позиции: 3 экваториальные (120°) и 2 аксиальные (90°): PCl₅."}},
        {"5:1", {"октаэдрическая", "квадратно-пирамидальная", 90, true, "Пара прижимает основание пирамиды: IF₅, BrF₅."}},

        {"6:0", {"октаэдрическая", "октаэдрическая", 90, true, "Правильный октаэдр, все связи равноценны: SF₆."}},

        {"7:0", {"пентагонально-бипирамидальная", "пентагонально-бипирамидальная", 72, true, "Редкая геометрия: IF₇."}},
    };
